...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/mingko3/okteto001/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'I can play the awesome Cloud NOW! - Message from zym!' >/var/www/html/index.html
